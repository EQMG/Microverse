...
namespace test
{
		...
		m_targetTab(nullptr)
	{
		...
		m_barTitle = new Text(this, UiBound(Vector2(0.01f, 0.99f), "TopLeft", false), 4.0f, "Microverse", FontFamily::Resource("Fonts/ProximaNova", FAMILY_BOLD), JUSTIFY_LEFT, 1.0f, 0.001f);
